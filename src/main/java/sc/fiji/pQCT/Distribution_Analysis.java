...
import sc.fiji.pQCT.analysis.DetermineAlfa;
...
import sc.fiji.pQCT.utils.ResultsImage;
			...
			*/
			...
			if (roi != null){	/*An analysis was conducted*/
				...
				if (imageAndAnalysisDetails.mOn){
					...
					MassDistribution
                            massDistribution =new MassDistribution((SelectROI) roi,imageAndAnalysisDetails,determineAlfa);
