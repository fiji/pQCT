...
/**
 * Modified by Timo Rantalainen 2012 - 2014 tjrantal at gmail dot com from
 * IvusSnakes (http://ivussnakes.sourceforge.net/) ImageJ plugin A Class to
 * calculate LiveWire paths.
 * <p>
 * Changed the implementation back to the one suggested in Barret & Mortensen
 * 1997. Interactive live-wire boundary extraction. Medical Image Analysis
 * (1996/7) volume 1, number 4, pp 331-341.
 * </p>
 */
